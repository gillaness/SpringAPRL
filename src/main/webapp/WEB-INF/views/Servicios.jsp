...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="${pageContext.request.contextPath}/">APRL</a>
    ...
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu" aria-labelledby="navbarDropdown">
          ...
          <a class="dropdown-item" href="/APRL/Diagramas/Tablas.sql">Tablas SQL</a>
      ...
      <li class="nav-item">
        <a class="nav-link" href="VistaAdministrador" tabindex="-1" aria-disabled="true">Acceso Administrador</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="VistaCliente" tabindex="-1" aria-disabled="true">Acceso Cliente</a>
      </li>
      <li class="nav-item">
        <a class="nav-link" href="VistaProfesional" tabindex="-1" aria-disabled="true">Acceso Profesional</a>
      </li>
    </ul>
