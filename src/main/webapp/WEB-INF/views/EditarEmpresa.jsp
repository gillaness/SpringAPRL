...
<body>
	...
	<form action="${pageContext.request.contextPath}/EditarEmpresa" method="post">
	<table>
		<tr>
		...
		<td><input type="text" name="cantidad" value="${datos.getHeadCount()}"></td>
		</tr>
	</table>
		<br>
	...
	<button onclick="window.location.href='${pageContext.request.contextPath}/VerEmpresas';">
		Volver
    	</button>
