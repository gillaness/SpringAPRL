...
<body>
	...
	<input type="text" value="${user.toString()}">
	 <h3>Selecciona una de las siguientes opciones</h3>   
		...
		<button type="submit" onclick="window.location.href='ReportarAccidente';" class="btn btn-secondary" value="Crear Reporte de Accidetentes">Crear Reporte de Accidetentes</button>
		<br><br>
